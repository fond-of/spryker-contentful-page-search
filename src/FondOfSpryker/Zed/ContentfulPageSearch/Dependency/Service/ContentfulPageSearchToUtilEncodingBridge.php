...
namespace FondOfSpryker\Zed\ContentfulPageSearch\Dependency\Service;

use Spryker\Service\UtilEncoding\UtilEncodingServiceInterface;

class ContentfulPageSearchToUtilEncodingBridge implements ContentfulPageSearchToUtilEncodingInterface
{
    /**
